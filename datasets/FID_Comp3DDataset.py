...
class FID_Comp3D(data.Dataset):
    ...
    def __init__(self, config):
        ...
        self.n_renderings = 30 if self.subset == 'train' else 10
        ...
        for dc in self.dataset_categories:
            ...
            for s in samples:
                for i in range(n_renderings):
                    file_path = self.partial_points_path % (subset, dc['taxonomy_id'], s, i)
